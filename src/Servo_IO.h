...
#define SERVO_GIMBAL_YAW_MID_POSE 186
#define SERVO_GIMBAL_YAW_UP_LIMIT 350
#define SERVO_GIMBAL_YAW_LOW_LIMIT 30

#define SERVO_GIMBAL_PITCH_MID_POSE 198
#define SERVO_GIMBAL_PITCH_UP_LIMIT 240
#define SERVO_GIMBAL_PITCH_LOW_LIMIT 160
